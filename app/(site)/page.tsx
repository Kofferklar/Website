...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Entdecke das 8-teilige Kompressions-Packwürfel-Set von KofferKlar. Spare bis zu 60% Platz in deinem Koffer und reise absolut stressfrei und organisiert.',
    openGraph: {
