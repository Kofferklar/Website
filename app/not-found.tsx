  ...
  return (
    <CartProvider>
      ...
      <main id="main-content" className="min-h-[60vh] flex flex-col items-center justify-center gap-4 pt-[72px]">
        ...
        <Link href="/?utm_source=website&utm_medium=navigation&utm_campaign=kofferklar-launch" className="text-primary hover:underline transition-colors duration-200">
