...
async function seed() {
  ...
  await client.createOrReplace({
    ...
    shortDescription:
      'Das 8-teilige Kompressions-Packwürfel-Set. Pack klüger und reise leichter. Wasserabweisendes Polyester, robuste Reißverschlüsse und spürbar mehr Ordnung im Koffer.',
    material:
    ...
    description: [
      ...
      block('Der doppelte Reißverschluss hilft dir, Kleidung flacher und strukturierter zu packen. So nutzt du den Platz im Koffer besser aus und findest unterwegs schneller, was du suchst.'),
      block('Material & Qualität', 'h2'),
      block('Außenmaterial: 420D wasserabweisendes Polyester. Die Reißverschlüsse laufen stabil, die Nähte sind doppelt verstärkt und für regelmäßige Reisen ausgelegt.'),
    ],
    setParts: [
  ...
  const posts = [
    ...
    },
    {
      ...
      seo: {
        ...
        description: 'Praktische Packanleitung für eine Woche im Handgepäck mit Kategorien, Packprofilen und dem 8-teiligen KofferKlar Set.',
      },
      body: [
        block('Nur Handgepäck für eine ganze Woche klingt erst einmal knapp. Mit klaren Kategorien, leichten Basics und dem richtigen Packsystem wird es deutlich einfacher.'),
        ...
        block('Mit Kompressions-Packwürfeln trennst du Kleidung nach Kategorien und drückst weiche Teile flacher zusammen. Das macht dein Handgepäck übersichtlicher und leichter zugänglich.'),
        block('So nutzt du dein Kofferklar Set richtig', 'h2'),
        block('1. Kleidung nach Kategorien sortieren. 2. Große Kleidung in den großen Cube legen. 3. T-Shirts und leichte Kleidung in den mittleren Cube packen. 4. Unterwäsche und Socken in den kleinen Cube geben. 5. Schuhe separat verstauen. 6. Wäschebeutel für die Rückreise einplanen.'),
        block('Drei Packprofile', 'h2'),
        block('Wochenendtrip: Nutze einen mittleren Cube für zwei Outfits, einen kleinen Cube für Unterwäsche und Socken, den Kulturbeutel und den Wäschebeutel. Sommerurlaub: Leichte Kleidung kommt in den großen und mittleren Cube, Badekleidung und Kleinteile in die kleinen Cubes. Geschäftsreise: Hemden oder Blusen kommen flach in den großen Cube, Basics und Sportkleidung getrennt, Schuhe in den Schuhbeutel.'),
        block('Kleidung strategisch wählen', 'h2'),
        block('Merino-Wolle ist geruchsresistent und mehrfach tragbar ohne Waschen. Synthetische Sportbekleidung trocknet schnell nach der Handwäsche. Beides spart Kleidungsmenge.'),
      ],
    },
    {
      ...
      body: [
        ...
        block('Kompressions-Packwürfel haben eine Doppelkammer-Konstruktion mit zweitem Reißverschluss. Sie helfen, weiche Kleidung flacher zu packen und Kategorien im Koffer klar zu trennen.'),
